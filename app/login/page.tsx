      ...
      <Card className="w-full max-w-md card-luxury">
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <Input
                ...
                placeholder="admin@oudperfume.ae"
                required
            ...
            <div className="text-sm text-oud-600 bg-oud-50 p-3 rounded-md">
              <p className="font-medium mb-1">Demo Credentials:</p>
              <p>Email: admin@oudperfume.ae</p>
          ...
          <p className="mt-6 text-center text-sm text-oud-600">
            <Link href="/" className="font-medium text-oud-600 hover:text-oud-500">
              ← Back to Home
            </Link>
          </p>
        </CardContent>
